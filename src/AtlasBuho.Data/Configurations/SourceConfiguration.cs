...
public class SourceConfiguration : IEntityTypeConfiguration<Domain.Entities.Source>
{
    public void Configure(EntityTypeBuilder<Domain.Entities.Source> builder)
    {
        ...
        builder.Property(e => e.Description).HasColumnName("Description").HasMaxLength(5000);
        ...
        builder.Property(e => e.Authors).HasColumnName("Authors").HasMaxLength(2000);
        builder.Property(e => e.Editors).HasColumnName("Editors").HasMaxLength(2000);
